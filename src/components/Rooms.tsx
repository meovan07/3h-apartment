...
function RoomCard({
  ...
  return (
    <motion.article
      ...
      className="group flex flex-col bg-cream rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(12,31,53,0.07)] hover:shadow-[0_6px_28px_rgba(12,31,53,0.12)] transition-shadow duration-300"
    >
      {/* Image */}
